...
# service that serves the frontend (default: extrato-front). It configures a
...
#   SERVICE_FRONT="extrato-front"
#   DOMAIN_NAME="mensageiros.udi.br"       # The custom domain to link
#
# Optional env vars:
#   FIREBASE_SITE_ID="extrato-front-site"  # Default derived from PROJECT_ID if empty
...
SERVICE_FRONT=${SERVICE_FRONT:-extrato-front}
