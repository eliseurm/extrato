...
public interface LancamentoRepository extends JpaRepository<Lancamento, Long> {
    ...
    @Query("select l from Lancamento l where l.pessoa = :pessoa and l.dataPrevista between :start and :end order by case when l.dataEfetiva is null then l.dataPrevista else l.dataEfetiva end asc")
